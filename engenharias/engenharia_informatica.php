...
<head>
    ...
    <title>Engenharia Informática - Garimpo</title>
    ...
    <main class="container">
        ...
        <div class="way ">
            <a href="../index.php">Inicial</a>/ <a href="">Engenharias</a>/ <a
                href="engenharia_eletrotecnica.php">Eng. Informática</a>
            <hr>
        </div>
        <br>
        ...
        <?php
            ...
            $get_c = "SELECT *  FROM posts WHERE curso = 'Eng. Informática'";
        ...
        <br>
        <div>
<center><h3>Casos de Informática</h3></center>
<hr>
<br>
